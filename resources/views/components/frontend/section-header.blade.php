            ...
            <div class="flex-1">
                ...
                @if ($report)
                    <a href="{{ route('scd-report.download', $year->year) }}"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-brand-red hover:bg-brand-red-dark text-white font-semibold rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg text-sm">
