                            ...
                            @foreach ($chunk as $section)
                                ...
                                <a href="{{ route('scd.section', [$activeYear->year, $sectionSlug]) }}"
                                    ...
                                    <div class="transition-transform duration-300 hover:-translate-y-2">
                                        <!-- รูปภาพ -->
                                        <div
                                            class="relative aspect-video bg-gray-200 overflow-hidden shadow-md group-hover:shadow-xl transition-shadow duration-300">
                                            ...
                                            @else
                                                <div
                                                    ...
                                                    <svg class="w-16 h-16 text-red-600" fill="currentColor"
                                                        viewBox="0 0 20 20">
                                                        <path
                                        ...
                                        <!-- ชื่อด้านล่าง -->
                                        <h3
                                            class="mt-4 text-base font-normal text-gray-800 group-hover:text-red-600 transition-colors duration-200">
                                            {{ $section->name }}
                                        </h3>
                                    </div>
                                </a>
