...
<body class="antialiased bg-gray-50 flex flex-col min-h-screen">
    ...
    <div class="bg-[#FFD87F]">
        <div class="max-w-7xl mx-auto px-3 sm:px-4 py-2 sm:py-2.5">
            <p class="text-center text-xs sm:text-sm md:text-base font-light text-[#1e3c72]">
    ...
    <div class="flex-grow flex flex-col justify-center items-center px-4 py-8 sm:py-12">
        <div class="max-w-lg w-full">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <!-- Header -->
                <div class="bg-gradient-to-r from-[#af1a00] to-red-700 px-4 sm:px-6 md:px-8 py-5 sm:py-6 text-center">
                ...
                <div class="p-6 sm:p-8 text-center">
                    ...
                    <div class="mb-5 sm:mb-6">
                        <div class="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-red-50 rounded-full">
                            <svg class="w-7 h-7 sm:w-8 sm:h-8 text-[#af1a00]" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center">
                        <a href="{{ url('/') }}"
                            class="w-full sm:w-auto px-5 sm:px-6 py-2.5 sm:py-3 bg-[#af1a00] text-white text-sm sm:text-base font-medium rounded-lg hover:bg-red-700 transition-colors duration-200">
                            กลับหน้าหลัก
                        </a>
    ...
    <!-- Footer -->
    <footer class="bg-[#2d2921] text-center py-3 sm:py-4 text-white px-4">
