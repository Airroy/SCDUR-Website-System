    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-4 sm:px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div>
                ...
                <p class="text-xs text-gray-500 mt-0.5">สไลด์ในหมวด "แสดงผล" จะเรียงจากใหม่ → เก่า อัตโนมัติ</p>
            </div>
    ...
    @else
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="bg-green-600 px-4 sm:px-6 py-4 flex items-center justify-between">
                ...
                <span class="inline-flex items-center justify-center min-w-[2rem] h-8 px-3 rounded-full bg-white/20 text-white text-sm font-bold">
                        ...
                        <div class="p-4 hover:bg-gray-50">
                            ...
                            <div class="flex items-center gap-2 mb-2 text-xs">
                                @if ($banner->link_type === 'url')
                                    <span class="px-2 py-0.5 rounded-full bg-blue-100 text-blue-800 font-medium">URL</span>
                                @elseif ($banner->link_type === 'pdf')
                                    <span class="px-2 py-0.5 rounded-full bg-orange-100 text-orange-800 font-medium">PDF</span>
                                @else
                                    <span class="px-2 py-0.5 rounded-full bg-gray-100 text-gray-800 font-medium">ไม่มีลิงค์</span>
                                @endif
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-green-50">
                            <tr>
                                ...
                                <th class="w-28 px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ประเภท</th>
                                <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ลิงค์/ไฟล์</th>
                                <th class="w-40 px-4 lg:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">จัดการ</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 lg:px-6 py-3 whitespace-nowrap">
                                        @if ($banner->link_type === 'none')
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">ไม่มีลิงค์</span>
                                        @elseif ($banner->link_type === 'url')
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">URL</span>
                                        @else
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">PDF</span>
                                        @endif
                                    </td>
