<div class="bg-white rounded-lg shadow">
    ...
    <div
        ...
        <div class="flex items-center gap-2 w-full sm:w-auto">
            ...
            @endif
            @livewire(
                'backend.content-section-manager',
                [
                    'year' => $selectedYear,
            ...
            @foreach ($contents as $content)
                <div class="p-4 hover:bg-gray-50">
                    ...
                    <div class="flex items-start justify-between gap-3 mb-3">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span
                                    class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $content->type === 'folder' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800' }}">
                                    {{ $content->type === 'folder' ? 'หมวดหมู่' : 'ไฟล์' }}
                                </span>
                            </div>

                            @if ($content->type === 'folder')
                                <button wire:click="$dispatch('viewFolder', { folderId: {{ $content->id }} })"
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        @endif
                        <button wire:click="$dispatch('openEditContentModal', { contentId: {{ $content->id }} })"
                        ...
                        <button wire:click="$dispatch('deleteContent', { contentId: {{ $content->id }} })"
